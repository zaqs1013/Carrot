...
const Body = ({ setMode, Mode, selectedCategory }) => {
  const [topics, setTopics] = useState([
    { my: false,id: 1, name: "레고", location: "서울", note: "조립 완료", purchase: true, status: "판매 중", image: legoImage, category: "장난감", money: "2,000원" },
    { my: true,id: 2, name: "키보드", location: "천안", note: "잔기스", purchase: true, status: "판매 중", image: keyboard, category: "PC용품", money: "32,000원" },
    { my: false,id: 3, name: "모닝", location: "인천", note: "나", purchase: false, status: "구매", image: mo, category: "자동차", money: "3,200만원" },
  ]);
